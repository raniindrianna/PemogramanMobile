    ...
    public void onBindViewHolder(@NonNull TaskViewHolder holder, int position) {
        ...
        holder.mainLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Task task = new Task(currentTask.getTitle(), currentTask.getCourse(),
                        currentTask.getDate(), currentTask.getTime(), currentTask.getDesc());
                Intent item = new Intent(context, activity_detail_task.class);
